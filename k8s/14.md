...
|-----------|------------|-------------|--------------|
😿  service default/moscow-app has no node port
❗  Services [default/moscow-app] have type "ClusterIP" not meant to be exposed, however for local development minikube allows you to access this !
🏃  Starting tunnel for service moscow-app.
|-----------|------------|-------------|------------------------|
| NAMESPACE |    NAME    | TARGET PORT |          URL           |
|-----------|------------|-------------|------------------------|
| default   | moscow-app |             | http://127.0.0.1:44425 |
|-----------|------------|-------------|------------------------|
🎉  Opening service default/moscow-app in default browser...
